...
void main() {
  ...
  late MockMovieRemoteDatasources mockRemoteDataSource;
  late MockMovieLocalDatasources mockLocalDataSource;
  late MockNetworkInfo mockNetworkInfo;

  setUp(() {
    mockRemoteDataSource = MockMovieRemoteDatasources();
    mockLocalDataSource = MockMovieLocalDatasources();
